...
map.getView().fit([-8180084.748472, -2890302.760123, -5968586.860523, -1039038.835346], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA DE ESTACIONES DE BOLIVIA</h2>';
        return titleElement;
    })(),
